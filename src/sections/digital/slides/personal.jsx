...
export default () => {
  ...
  return (
    <SlideWrapper>
      ...
      <ParaText size='1.2em' weight='bold'>
        Now, as more and more companies are realizing the power of digital channels in engaging with customers, IKEA has pushed to increase its touchpoints in online mediums. Apart from the obvious touchpoint where someone like <ColorText color='primary'>{userName !== 'Our customer' ? userName : 'a customer'}</ColorText> can browse for couches that catch their eye online, IKEA now has online customer support through social media. Speaking of social media, IKEA has found a perfect outlet for their professionally decorated rooms through <TextReveal label={<span>📸</span>} reveal={<span>Instagram</span>}/> as a touchpoint with those looking for aesthetically pleasing design inspiration. It's a perfect marriage that has resulted in IKEA gaining <ColorText color='green'>1.7+ million Instagram followers</ColorText> on their single largest USA account as of writing.
      </ParaText>
      <ParaText size='1.2em' weight='bold'>
        Additionally, IKEA has experimented with providing some of their optional services online as a way to increase convenience. Most online customers are usually looking to accomplish a predefined goal in a <i>convenient</i> manner, and streamlining their access to the goal is priority number one. It's why IKEA offers online ordering for pickup at a collection point, an online design planner, and why they acquired TaskRabbit to provide assembly services for an alternative audience that prefers not to assemble their own furniture (at the cost of <TextReveal label={<span>💸</span>} reveal={<span>savings</span>}/>).
      </ParaText>
    </SlideWrapper>
  );
};
